...
import os
import time
from ipaddress import ip_interface, IPv4Network, IPv6Address
    ...
    def program_switches(self):
        ...
        **Assumes**
        ...
        for p4switch, info in self.p4switches(withInfo=True):
            ...
            s1 = self.net.get(p4switch)
            for intf1 in s1.intfs.values():
                if intf1.name == 'lo' or intf1.name.__contains__("veth"):
                    continue
...
# Generic methods
    ...
    def cmd_hosts(self, hosts, cmd, is_server, wait=True):
        #self.net.hosts
        i=0
        if is_server:
            for h in hosts:
    ...
    def startNetwork(self):
        ...
        start_int_collector(influxdb="gimli.run.montefiore.ulg.ac.be:8086")
